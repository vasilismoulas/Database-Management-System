...
<div class="sidebar">
  ...
  <div class="dropdown-content">
        ...
        <a class="menu-text active" href="proximity_sensor.php">Proximity</a>
  </div>
  </div>
...
<!-- Page content -->
<div class="content">
<form action="proximity/insert.php" method="post">
    <table>
        <tr>
            <th>Field</th>
            <th>Value</th>
        ...
        <tr>
            <td>Proximity:</td>
            <td><input type="text" name="proximity" required></td>
        </tr>
        <tr>
...
<form action="proximity/delete.php" method="post">
    <table>
        <tr>
            <th>Field</th>
            <th>Value</th>
