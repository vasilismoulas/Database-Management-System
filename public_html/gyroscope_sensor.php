...
<div class="sidebar">
  ...
  <div class="dropdown-content">
        ...
        <a class="menu-text active" href="gyroscope_sensor.php">Gyroscope</a>
...
<!-- Page content -->
<div class="content">
<form action="gyroscope/insert.php" method="post">
    <table>
        <tr>
            <th>Field</th>
            <th>Value</th>
        ...
        <tr>
            <td>gyroscope_x:</td>
            <td><input type="number" name="gyroscope_x" step="0.00000000000000001" required></td>
        </tr>
        <tr>
            <td>gyroscope_y:</td>
            <td><input type="number" name="gyroscope_y" step="0.00000000000000001" required></td>
        </tr>
        <tr>
            <td>gyroscope_z:</td>
            <td><input type="number" name="gyroscope_z" step="0.00000000000000001" required></td>
        </tr>
        <tr>
...
<form action="gyroscope/delete.php" method="post">
    <table>
        <tr>
            <th>Field</th>
            <th>Value</th>
