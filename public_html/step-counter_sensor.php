...
<div class="sidebar">
  ...
  <div class="dropdown-content">
        ...
        <a class="menu-text active" href="step-counter_sensor.php">Step-counter</a>
...
<!-- Page content -->
<div class="content">
<form action="step-counter/insert.php" method="post">
    <table>
        <tr>
            <th>Field</th>
            <th>Value</th>
        ...
        <tr>
            <td>Footsteps:</td>
            <td><input type="number" name="footsteps" required></td>
        </tr>
        <tr>
...
<form action="step-counter/delete.php" method="post">
    <table>
        <tr>
            <th>Field</th>
            <th>Value</th>
